<div class="bg-white/20 rounded-2xl shadow-xl p-4 sm:p-6 mb-12 ring-1 ring-gray-200/50">
    ...
    <a href="{{ route('show-category', $category->slug) }}"
       class="inline-flex items-center gap-3 px-6 sm:px-8 py-3 sm:py-4 mb-8 bg-white hover:bg-gray-300
    ...
    <div class="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
